...
<div class="jumbotron">
<h2 class="display-4 text-center">博客分类</h2>

<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">MySQL相关</h3>
        <p class="card-text">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">Redis相关</h3>
        <p class="card-text">
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">MongoDB相关</h3>
        <p class="card-text">
